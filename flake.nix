{
  ...
  outputs = inputs@{ self, nixpkgs, home-manager, assistant, ... }: let
    ...
    server3080Nix = builtins.fetchurl {
      ...
      sha256 = "01g084i1626xmccpc7hl9j3aj0nzmbzij0krq2rcmz535inn69dn";
    };
    ...
    serverMacbookProNix = builtins.fetchurl {
      url = "https://raw.githubusercontent.com/fursman/NixOS/main/config/serverMacbookPro.nix";
      sha256 = "";
    };
